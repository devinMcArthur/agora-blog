...
const createQuestions = () => {
  return new Promise<SeededQuestions>(async (resolve, reject) => {
    try {
      ...
      const are_asymptomatic_cases_of_covid_19_a_large_contributer_to_spread = new Question(
        {
          _id:
            _ids.questions
      ...
      const what_is_the_false_positive_rate_of_rt_pcr_covid_19_tests = new Question(
        {
          _id:
            _ids.questions
      ...
      const what_is_the_false_negative_rate_of_rt_pcr_covid_19_tests = new Question(
        {
          _id:
            _ids.questions
      ...
      const how_does_cycle_threshold_ct_affect_rt_pcr_test_accuracy = new Question(
        {
          _id:
            _ids.questions
      ...
      const what_is_the_significance_of_cycle_threshold_for_rt_pcr_tests = new Question(
        {
          _id:
            _ids.questions
      ...
      const why_did_florida_mandate_reporting_of_cycle_threshold_value_for_rt_pcr_tests = new Question(
        {
          _id:
            _ids.questions
