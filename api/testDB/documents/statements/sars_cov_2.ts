...
// page_sars_cov_2
const page_sars_cov_2_sentence_1_v1 = new Statement({
...
const page_sars_cov_2_sentence_2_v1 = new Statement({
...
const page_sars_cov_2_sentence_3_v1 = new Statement({
...
const page_sars_cov_2_sentence_4_v1 = new Statement({
  ...
  questions: [_ids.questions.how_is_the_spread_of_covid_19_being_slowed._id],
});
