...
const page_covid_19_transmission_sentence_1_v1: Sentence = {
  _id: _ids.pages.page_covid_19_transmission.paragraphs[0].sentences[0],
...
const page_covid_19_transmission_sentence_2_v1: Sentence = {
  _id: _ids.pages.page_covid_19_transmission.paragraphs[0].sentences[1],
  pageID: _ids.pages.page_covid_19_transmission._id,
  current: true,
  versions: [
    {
...
const page_covid_19_transmission_sentence_3_v1: Sentence = {
  _id: _ids.pages.page_covid_19_transmission.paragraphs[0].sentences[2],
  pageID: _ids.pages.page_covid_19_transmission._id,
  current: true,
  versions: [
    {
